...
function TableWrapData({
  ...
  return (
    <div className="w-full ">
      ...
      <div className="flex flex-col items-center justify-center space-x-2  h-[120px] bg-neutral-100 border-b px-3 border-t gap-2">
        <div className=" text-sm text-neutral-500  ">
          <p className="text-xs">총 {data?.pageCount}개의 데이터가 있습니다.</p>
        </div>
        {data?.pageCount && data?.pageCount > 10 ? (
          <div className="space-x-2 flex flex-row items-center justify-center gap-2 ">
            <Button
              type="button"
